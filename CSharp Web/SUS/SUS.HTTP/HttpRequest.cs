namespace SUS.HTTP
{
    ...
    public class HttpRequest
    {
        ...
        public HttpRequest(string requestString)
        {
            ...
            var cookieHeader = this.Headers.FirstOrDefault(x => x.Name == HttpConstants.RequestCookieHeader);

            if (cookieHeader != null)
            {
                var cookiesAsString = cookieHeader.Value;
            ...
            var sessionCokie = this.Cookies.FirstOrDefault(x => x.Name == HttpConstants.SessionCookieName);
            ...
            else if (!Sessions.ContainsKey(sessionCokie.Value))
            {
                this.Session = new Dictionary<string, string>();
                Sessions.Add(sessionCokie.Value, this.Session);
            }
            else
            {
